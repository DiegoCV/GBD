...
class VendedorController {
  ...
  public static function login($uSUARIO, $pASS){
    $vendedor = new Vendedor();
      $vendedor->setUSUARIO_VENDEDOR($uSUARIO); 
      $vendedor->setPASS_VENDEDOR($pASS); 

     $FactoryDao=new FactoryDao(self::getGestorDefault());
     $administradorDao =$FactoryDao->getVendedorDao(self::getDataBaseDefault());
     $result = $administradorDao->login($vendedor);
